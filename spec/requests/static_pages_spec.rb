...
describe "Static pages" do
	...
	describe "Home page" do
	  it "should have the h1 'Development App'" do
	  ...
	  it "should have the base title 'Home'" do
	  	visit '/static_pages/home'
	  	page.should have_selector('title', :text => "Ruby on Rails Tutorial Development App")
	  end
	...
	describe "Contact page" do
		it "should have the h1 'Contact'" do
			...
			page.should have_selector('title', :text => "Ruby on Rails Tutorial Development App | Contact")
		end
	end
end
